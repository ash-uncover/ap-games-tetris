...
const AppLoading = ({
  ...
  const audios = [
    `${CONFIG.AP_GAMES_TETRIS_PUBLIC}/sound/click.mp3`,
    `${CONFIG.AP_GAMES_TETRIS_PUBLIC}/sound/gong.mp3`,
    `${CONFIG.AP_GAMES_TETRIS_PUBLIC}/sound/music_0.mp3`,
    `${CONFIG.AP_GAMES_TETRIS_PUBLIC}/sound/music_0.mp3`,
    `${CONFIG.AP_GAMES_TETRIS_PUBLIC}/sound/music_1.mp3`,
    `${CONFIG.AP_GAMES_TETRIS_PUBLIC}/sound/music_2.mp3`,
    `${CONFIG.AP_GAMES_TETRIS_PUBLIC}/sound/music_3.mp3`,
    `${CONFIG.AP_GAMES_TETRIS_PUBLIC}/sound/music_4.mp3`,
    `${CONFIG.AP_GAMES_TETRIS_PUBLIC}/sound/music_5.mp3`
  ]

  const images = themes.map((theme: any) => {
    return theme.attributes.thumbnail
  })
  images.push(`${CONFIG.AP_GAMES_TETRIS_PUBLIC}/images/thumbnail_random.jpg`)
